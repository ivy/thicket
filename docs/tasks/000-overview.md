...
| [048 A merge is gated on independent agent verdicts (research)](048-independent-review-gate.md) | 023, 024, 028 | `.` | none |
| [049 netd's tolerance of an absent agentd is untested](archived/049-netd-late-upstream-test.md) | 047 | `netd` | go |
| [050 The gate lints TypeScript but not Go](archived/050-go-formatting-gate.md) | — | `.` | none |
